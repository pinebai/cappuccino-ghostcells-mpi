...
! 3)  Precomute and store cell face areas
! 4)  Set Coefficient values for Turbulence models
! 5)  Set Index Arrays For Cell Looping, Set Monitoring Point And Pressure Reference Point
! 6)  Set Initial timestepping control values
! 7)  Various initialisations
!     7.1)  Field Initialisation
...
!***********************************************************************
!
      INTEGER :: I, J, K, IJ, IK, JK, INP, IJK, NGR,intc,inbc
      integer :: idew,idns,idtb,ine,ins,inb,inbs
      real(prec) :: ednom, tenom
      real(prec) :: dxet,dxzd,dyet,dyzd,dzet,dzzd
      REAL(PREC) :: perturb!,zz
      !REAL(PREC) :: UST 
...
!
! 3.1)  Calculation of interpolation factors - new method
!.......................................................................
...
!.....READ FIELD VALUES - RESULTS OF PREVIOUS RUN
      ...
      CALL READFILES
        DO INP=ICST,ICEN
          !ed(inp)=ed(inp)/(cmu*te(inp)+small) !restart napravljen sa k-eps!
          PP(INP)=P(INP)
        END DO
      END IF
